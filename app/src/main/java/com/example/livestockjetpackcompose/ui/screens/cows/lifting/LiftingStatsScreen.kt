...
@Composable
fun LiftingStatsScreen(modifier: Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
        ...
        Title(Modifier.weight(1f), "Estadisticas Vaca 112233")
        CardWeightList(Modifier.weight(2f))
        GraphCard(Modifier.weight(3f))
        RegisterWeightButton(Modifier.weight(1f))
    }
}

@Composable
private fun CardWeightList(modifier: Modifier) {
    Card(
        modifier = modifier
            .fillMaxSize()
...
@Composable
private fun GraphCard(modifier: Modifier) {
    val steps = 5
...
@Composable
private fun RegisterWeightButton(modifier: Modifier) {
